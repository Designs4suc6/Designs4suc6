...
const Banner = () => {
  ...
  return (
    <div
      id="home-section"
      className="bg-[#EAEAEA] py-3 md:py-3.5 lg:py-4 relative"
    >
          ...
          <div className="md:col-span-7 flex flex-col justify-center">
            ...
            >
              ...
              <p
                ...
                style={{ color: "#645F5A" }}
              >
                Jouw onderneming is uniek, en jouw website hoort dat ook te
                zijn. Ik bouw websites volledig op maat, zonder gebruik te
                maken van standaardtemplates. Samen creëren we een ontwerp dat
                perfect aansluit bij jouw wensen en uitstraling. Het design kan
                ik lokaal ontwikkelen, zodat je geen hostingkosten hebt totdat
                de site klaar is. Heb je al een website? Dan help ik je graag
                met aanpassingen, nieuwe functies of een complete redesign.
                Daarnaast ondersteun ik je bij het instellen van hosting, of
                neem ik dit – tegen vergoeding – volledig voor je uit handen.
                Ook verzorg ik de juiste SEO, zodat je website beter gevonden
                wordt. Na de lancering blijf ik beschikbaar voor updates en
                onderhoud. Elke maand update en back-up ik je website, zodat
                problemen tijdig worden voorkomen.
              </p>
      ...
      <style jsx global>{`
        ...
        .pc-shell-rim {
          ...
          box-shadow:
            ...
            inset 0 0 40px 18px rgba(200, 205, 215, 0.3);
